...
ui_employment_emp_ind_feature_table <- function(chart, df1){
  column(9,
         ...
         fluidRow(style = "background-color: #f2f2f2;margin-right: 0px; margin-left: 0px;margin-top: 0px; margin-left: 0px;",
                  column(4, div(class = "upward-dropdown", selectInput("employment_emp_ind_table_geo", "", choices = unique(df1$geo), selected = "British Columbia" ))),
                  column(4, div(class = "upward-dropdown", selectInput("employment_emp_ind_table_parent", "", choices = unique(df1$parent_secor), selected = "business sector industries"))),
                  ),
         fluidRow(style = "background-color: #f2f2f2;margin-right: 0px; margin-left: 0px;margin-top: 0px; margin-left: 0px;",
                  column(4),
                  column(4), 
                  ...
                  column(2, style = "background-color: #f2f2f2; height: 20px; padding-top: 40px; display: flex; justify-content: center; align-items: center;", 
                         downloadButton("employment_emp_ind_table_dwnbtt", label = NULL, class = "btn-custom-black", icon = icon("cloud-download-alt")))),
  )
}
